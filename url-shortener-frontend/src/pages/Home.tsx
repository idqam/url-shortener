    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ maxWidth: 620, textAlign: "center", marginBottom: "3.5rem" }}
        >
          <h1
          ...
          >
            Paste a long link, get a clean short one. Track every click with
            built-in analytics.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: "Use your own branded domain",
            },
            {
              icon: BarChart3,
              title: "Advanced Analytics",
              desc: "Fine-grain click insights",
            },
      ...
      >
        ...
        >
          Basic analytics collected: click counts, referrer sources, device
          types. No personal data stored with your links.
        </p>
      </footer>
    </div>
  );
